...
<div id="login-panel">
	<div id="login-header">
		...
		<div id="error" class="hide alert alert-danger" style="display:none;">
		{if isset($errors)}
			<h4>
	...
	<div id="login-footer">
		<p class="text-center text-muted">
			<a href="#" onclick="return !window.open(this.href);">
				&copy; Grocery&#8482; 2007-{$smarty.now|date_format:"%Y"} - All rights reserved
			</a>
		</p>
