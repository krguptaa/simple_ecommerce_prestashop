...
{if isset($wishlists) && count($wishlists) > 1}
    <div class="buttons_bottom_block no-print panel-product-line panel-product-actions">
        <div id="wishlist_button" style="background-color:  white;">
            ...
            <select id="idWishlist"  style="margin-top: 3%;width: 99%;border: 1px solid;">
...
{else}
    <p class="panel-product-line panel-product-actions">
        <a id="wishlist_button" class="wishlist_button_extra_product" href="#" onclick="WishlistCart('wishlist_block_list', 'add', '{$id_product|intval}', $('#idCombination').val(), document.getElementById('quantity_wanted').value); return false;" rel="nofollow"  title="{l s='Add to my wishlist' mod='blockwishlist'}">
            {l s='Add to wishlist' mod='blockwishlist'}
        </a>
    </p>
{/if}