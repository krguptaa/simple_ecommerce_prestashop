...
*}
<ps-panel header="{l s='License Summary' mod='medgtranslate'}">
    <ul class="license">
...
<ps-panel header="{l s='Terms and conditions' mod='medgtranslate'}">

    <ol class="terms">
        <li>
            <p><strong>Preamble:</strong> This Agreement, signed on Feb 11, 2014 [hereinafter: Effective Date] governs the relationship between You (hereinafter: Licensee) and {$author|escape:'htmlall':'UTF-8'}, a duly registered company in France whose principal place of business is 20 rue des Saulniers 17230 VILLEDOUX, France (Hereinafter: Licensor). This Agreement sets the terms, rights, restrictions and obligations on using [{$name|escape:'htmlall':'UTF-8'}] (hereinafter: The Software) created and owned by Licensor, as detailed herein</p>
        </li>
